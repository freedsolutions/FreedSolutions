...
- Fully filled `SMOKE_TEST.md` content
...
- Browser extension flow is paste-only: paste the full contents of `SMOKE_TEST.md` into the browser thread.
...
6. Start browser smoke in the browser Claude extension by pasting full `SMOKE_TEST.md` content; DO NOT CLOSE OUT THE BROWSER.
...
5. Return filled `SMOKE_TEST.md` in terminal output
