...
|------|---------------|---------|-----------|
| `docs/agent-sops.md` | `323adb01-222f-81d7-bc47-c32cfea460f4` | Canonical operating model: agents, workflows, schema, runtime baseline, and manual operator rules | 2026-04-01 (S40) |
...
| `docs/post-email.md` | `325adb01-222f-81d3-825a-d3e0c74c0e30` | Post-Email Agent: timestamp-based sweep -> classification matrix -> CRM wiring -> schema-safe action items -> thread summary | 2026-04-02 (S47) |
