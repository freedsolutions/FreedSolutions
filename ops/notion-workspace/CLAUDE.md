...
|------|---------------|---------|-----------|
| `docs/agent-sops.md` | `323adb01-222f-81d7-bc47-c32cfea460f4` | Agents, workflows, databases, schema conventions | S61 |
| `docs/notion-agent.md` | `321adb01-222f-8033-ad89-c3f889ae4dec` | Notion's built-in AI personality config | S52 |
| `docs/post-meeting.md` | `324adb01-222f-8168-a207-d66e81884454` | Post-Meeting Agent: 4-step pipeline (CRM wiring → Floppy → Notes → Curated Notes). GCal sync-back retired S61. | S61 |
...
| `docs/curated-notes.md` | `325adb01-222f-8148-b544-f592271f34e3` | DEPRECATED S57 — folded into Post-Meeting Agent Step 3 | S57 |
| `docs/post-email.md` | `325adb01-222f-81d3-825a-d3e0c74c0e30` | Post-Email Agent: nightly Gmail sweep → CRM wiring → AI action item parse → thread summary | S60 |
| `docs/claude-ai-context.md` | `325adb01-222f-8144-9c87-e0412a17d5ef` | Claude.ai planning context — lightweight CLAUDE.md for chat sessions | S61 |
